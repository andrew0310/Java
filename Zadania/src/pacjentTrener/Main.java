...
//    }
    ...
    public static void main(String[] args) {
        ...
        Patient patient2 = new Patient("George", "Michael", Gender.MALE, 2131);
        Patient patient3 = new Patient("Ch", "Er", Gender.FEMALE, 532);
        Patient patient4 = new Patient("Cher", "Wir", Gender.FEMALE, 562);
        ...
        registrationDesk.addPatient(patient4);
        registrationDesk.addPatient(patient5);
